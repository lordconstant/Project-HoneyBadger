...
public:
	...
	AWSprite(string imageFileName, Sint32 hmf, bool share = false);
	AWSprite(string imageFileName, Sint32 cols, Sint32 rows, bool share = false);
	...
	AWSprite(string imageFileName, Sint32 hmf, string alphaMaskFileName, bool share = false);
	AWSprite(string imageFileName, Sint32 cols, Sint32 rows, string alphaMaskFileName, bool share = false);
	...
	void setImage(string imageFileName, Sint32 hmf = 1, bool share = false);
	void setImage(string imageFileName, Sint32 cols, Sint32 rows, bool share = false);
	void setImage(string imageFileName, Sint32 hmf, string alphaMaskFileName, bool share = false);
	void setImage(string imageFileName, Sint32 cols, Sint32 rows, string alphaMaskFileName, bool share = false);
private:
