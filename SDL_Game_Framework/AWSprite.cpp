...
AWSprite::AWSprite(string imageFileName, Sint32 hmf, bool share) {
	char charImg[255];
	strcpy_s(charImg, imageFileName.c_str());

	if (share){
		makeSharedImage(charImg, hmf, 1);
	}
	else{
		makePrivateImage(charImg, hmf, 1);
	}
}

AWSprite::AWSprite(string imageFileName, Sint32 cols, Sint32 rows, bool share) {
	char charImg[255];
	strcpy_s(charImg, imageFileName.c_str());

	if (share){
		makeSharedImage(charImg, cols, rows);
	}
	else{
		makePrivateImage(charImg, cols, rows);
	}
}
...
AWSprite::AWSprite(string imageFileName, Sint32 hmf, string alphaMaskFileName, bool share) {
	char charImg[255];
	strcpy_s(charImg, imageFileName.c_str());

	char charMask[255];
	strcpy_s(charMask, alphaMaskFileName.c_str());

	if (share){
		makeSharedImageWithAlpha(charImg, hmf, 1, charMask);
	}
	else{
		makePrivateImageWithAlpha(charImg, hmf, 1, charMask);
	}
}

AWSprite::AWSprite(string imageFileName, Sint32 cols, Sint32 rows, string alphaMaskFileName, bool share) {
	char charImg[255];
	strcpy_s(charImg, imageFileName.c_str());
	...
	if (share){
		makeSharedImageWithAlpha(charImg, cols, rows, charMask);
	}
	else{
		makePrivateImageWithAlpha(charImg, cols, rows, charMask);
	}
}
...
void AWSprite::setImage(string imageFileName, Sint32 hmf, bool share){
	freeImageMemory();
...
void AWSprite::setImage(string imageFileName, Sint32 cols, Sint32 rows, bool share){
	freeImageMemory();
...
void AWSprite::setImage(string imageFileName, Sint32 hmf, string alphaMaskFileName, bool share){
	freeImageMemory();
...
void AWSprite::setImage(string imageFileName, Sint32 cols, Sint32 rows, string alphaMaskFileName, bool share){
	freeImageMemory();
...
void AWSprite::set_animation_subset(Uint32 first, Uint32 last) {
	...
	if (get_currentFrame() < first || get_currentFrame() > last){
		set_currentFrame(firstFrame);
	}
}
