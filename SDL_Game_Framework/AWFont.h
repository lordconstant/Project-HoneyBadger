/* 
	...
	Version 2.02
	Changes made in V2.02 - Corey Bradford
		Added a print_string function that takes a std::string
...
public:
	...
	int AWFont::print_string(std::string string, int X, int Y)
	{
		SDL_Surface *onto = SDL_GetVideoSurface();
		return this->print_string(string.c_str(), X, Y, onto);
	}
